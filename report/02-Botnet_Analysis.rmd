...
## Analysis
We download the data from Google Drive and load it into R (warning: the truncated full capture is a large file, about 5.5 GB).
...
```{r}
drive_deauth()
drive_download(as_id("1FCv6atGZVrEqcJ4DwvDMgB675hGDRRIg"), path = "DonBotData.csv", overwrite = TRUE)
fullbotnetdata <- fread("DonBotData.csv")
```
